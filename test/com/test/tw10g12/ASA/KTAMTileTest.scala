    ...
    "An KTAM Simulation" should "allow a tile to be updated" in
        {
            ...
            terminateTileAbove.removeTileProbabilities._2 should contain allOf(new Vector3(0, 1, 0), new Vector3(0, -1, 0))
            ...
            chainTileBelow.removeTileProbabilities._2 should contain allOf(new Vector3(0, 1, 0), new Vector3(0, -1, 0))
            ...
            updateBoth.removeTileProbabilities._2 should contain allOf(new Vector3(0, 1, 0), new Vector3(0, -1, 0))
        }
}
