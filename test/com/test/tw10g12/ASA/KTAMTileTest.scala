...
class KTAMTileTest extends UnitSpec
{
    "A KTAM Simulation" should "allow a tile to be added" in
    {
        ...
        setTileAbove.removeTileProbabilities._2.keySet should contain (new Vector3(0, 1, 0))
        ...
        setTileBelow.removeTileProbabilities._2.keySet should contain (new Vector3(0, -1, 0))
        ...
        setBoth.removeTileProbabilities._2.keySet should contain allOf (new Vector3(0, -1, 0), new Vector3(0, 1, 0))
    }
